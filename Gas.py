...
##############################
 # USER AGENT #
ugen2=['Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.24 Safari/537.36']
ugen=['Mozilla/5.0 (Linux; Android 9; SM-A505F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.105 Mobile Safari/537.36']
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By Pariz bule Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
    ...
    def __metode__(self, cebok, user, pasw):
        ...
        try:
            for pw in pasw:
                ...
                ua2 = 'Mozilla/5.0 (Linux; Android 4.2.2; GT-I9082) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36'
